...
public class TaggerConfig extends Properties /* Inherits implementation of serializable! */ {
  ...
  static {
    ...
    defaultValues.put("serverPort", SERVER_PORT);
  }
  ...
  public TaggerConfig(String... args) {
    ...
    if (props.containsKey("convertToSingleFile")) {
      ...
      props.setProperty("model", props.getProperty("dump").trim());
        ...
        this.setProperty("serverPort", props.getProperty("serverPort").trim());        
      }else {
      mode = Mode.TAG;
    ...
    this.setProperty("serverPort", props.getProperty("serverPort", oldConfig.getProperty("serverPort")).trim()); //this isn't something we save from time to time
  }
  ...
  public int getServerPort() { return Integer.parseInt(getProperty("serverPort")); }
  ...
  private void dump(PrintWriter pw) {
    ...
    pw.println("     		  serverPort = " + getProperty("serverPort"));
    pw.flush();
  }
  ...
  private static void printGenProps() {
    ...
    System.out.println("# The port XML-RPC Service listening to for incoming requests. Default is 8000");    
    System.out.println("# serverPort = " + SERVER_PORT);
    System.out.println();
